...
export default Ember.Controller.extend(ModelsNavigationMixin, {
  ...
  modelRouteParams: Ember.computed('whiteboard.modelId', function () {
    return ['whiteboards.whiteboard.project', this.get('whiteboard.modelId')];
  }),
  ...
  actions: {
    hideSidePanel: function() {
      this.transitionToRoute('whiteboards.whiteboard', this.get('whiteboard.modelId'));
    }
  }
});
