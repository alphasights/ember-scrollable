...
this._super.apply(this,arguments),this.addEventListener(this.element,"scroll",function(t){e.scrolled(t)}),this.configureInitialScrollPosition()},didReceiveAttrs:function(){var e=this;["X","Y"].forEach(function(t){var n=e.get("previousScrollTo"+t),r=e.get("scrollTo"+t)
